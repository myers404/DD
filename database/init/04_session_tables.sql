-- database/init/04_session_tables.sql
-- Configuration Sessions for session-based architecture
-- This enables isolated user sessions with MTBDD state persistence
...
-- Add triggers to existing tables to update configuration_sessions timestamps
CREATE TRIGGER update_configuration_sessions_updated_at 
BEFORE UPDATE ON configuration_sessions 
FOR EACH ROW 
